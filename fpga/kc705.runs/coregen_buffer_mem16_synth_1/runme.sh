...
HD_PWD='G:/fei/chester0536/kc705/fpga/kc705.runs/coregen_buffer_mem16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coregen_buffer_mem16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coregen_buffer_mem16.tcl

...
HD_PWD='G:/fei/chester0536/kc705/fpga/kc705.runs/coregen_sysclk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coregen_sysclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coregen_sysclk.tcl

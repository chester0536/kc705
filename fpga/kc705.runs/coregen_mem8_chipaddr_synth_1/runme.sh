...
HD_PWD='G:/fei/chester0536/kc705/fpga/kc705.runs/coregen_mem8_chipaddr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coregen_mem8_chipaddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coregen_mem8_chipaddr.tcl

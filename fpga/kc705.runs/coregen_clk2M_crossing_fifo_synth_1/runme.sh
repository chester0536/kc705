...
HD_PWD='G:/fei/chester0536/kc705/fpga/kc705.runs/coregen_clk2M_crossing_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coregen_clk2M_crossing_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coregen_clk2M_crossing_fifo.tcl

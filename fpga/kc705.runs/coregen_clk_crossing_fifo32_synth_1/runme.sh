...
HD_PWD='G:/fei/chester0536/kc705/fpga/kc705.runs/coregen_clk_crossing_fifo32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coregen_clk_crossing_fifo32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coregen_clk_crossing_fifo32.tcl

...
HD_PWD='G:/fei/chester0536/kc705/fpga/kc705.runs/pcie_k7_vivado_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcie_k7_vivado.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcie_k7_vivado.tcl

...
HD_PWD='G:/fei/chester0536/kc705/fpga/kc705.runs/coregen_user_mem8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coregen_user_mem8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coregen_user_mem8.tcl
